...
lax_js__WEBPACK_IMPORTED_MODULE_0___default().init();

lax_js__WEBPACK_IMPORTED_MODULE_0___default().addDriver(
	"scrollY", // Driver name
	function () {
...
const handlerLax = () => {
	lax_js__WEBPACK_IMPORTED_MODULE_0___default().addElements("[data-lax-effect-bands]", {
		scrollY: {
			style: [
	...
	lax_js__WEBPACK_IMPORTED_MODULE_0___default().addElements("[data-lax-slider]", {
		scrollY: {
			style: [
	...
	lax_js__WEBPACK_IMPORTED_MODULE_0___default().addElements("[data-lax-bg-img]", {
		scrollY: {
			translateY: [
				["elInY", "elOutY"],
				[0, "-400"],
	...
	lax_js__WEBPACK_IMPORTED_MODULE_0___default().addElements("[data-lax-translate-easy]", {
		scrollY: {
			translateY: [
				["elInY", "elOutY"],
				["100", "-100"],
