...
$page_label_before = $img_id ? '<div class="page-header-decor"><div class="vertical-line"></div><br><div data-animate="up">' : null;
$page_label_after = $img_id ? '</div></div>' : null;
$page_label = get_sub_field('title_type') !== 'default' ? "$page_label_before<div class='page-header-decor__label'>" . get_the_title() . "</div>$page_label_after" : null;
    ...
    <div class="<?= CONTENT_BLOCK_CONTENT; ?> section-pt text-center">
        ...
        if ($img_id) :
            ...
            <div class="pos-rel min-height-lg" data-animate>
                <?php
                echo $page_label;
                echo "<div class='overflow-hidden stretch'>";
